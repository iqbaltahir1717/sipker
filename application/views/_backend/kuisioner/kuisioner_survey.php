                ...
                <div class="content hero1">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-sm-12">
                            ...
                            <h1>Silahkan Mengisi Survey "EVALUASI KEPUASAN MAHASISWA TERHADAP FASILITAS DAN DOSEN FAKULTAS TEKNIK"</h1>
                        </div>
                    </div>
                    <br><br><br>
                    <small>Page rendered in <strong>{elapsed_time}</strong> seconds.</small>
                    <?php echo form_open_multipart("mahasiswa/kuisioner/submit_answer") ?>
                    <?php echo csrf(); ?>
