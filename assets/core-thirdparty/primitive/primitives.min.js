...
primitives.common.Callout.prototype._betweenPoint = function(a, b) {
    return new primitives.common.Point((a.x + b.x) / 2, (a.y + b.y) / 2)
};
primitives.common.Callout.prototype._offsetPoint = function(a, b, c) {
    var d = new primitives.common.Point(a);
    a.x < b.x ? d.x += c : a.x > b.x ? d.x -= c : d.y = a.y < b.y ? d.y + c : d.y - c;
    return d
};
...
primitives.common.Connector.prototype.draw = function(a, b, c) {
    ...
    q = 1.5 * r;
    var s, t, u, a = (new primitives.common.Rect(a)).offset(this.offset),
    ...
    n = Math.max(this.hasLabel ?
        s.width : 0, 5 * j);
    if (a.right() + n < b.left() || a.left() > b.right() + n)
        if (a.left() > b.right() ? (d = new primitives.common.Point(a.left(), a.verticalCenter()), e = new primitives.common.Point(b.right(), b.verticalCenter())) : (d = new primitives.common.Point(a.right(), a.verticalCenter()), e = new primitives.common.Point(b.left(), b.verticalCenter())), g = new primitives.common.Rect(d, e), p = d.y <= e.y, n = d.x < e.x, g.height < g.width) {
            ...
            l = s.width < 2 * (g.width / 5) ? this._quadraticBezierPoint(d, new primitives.common.Point(g.horizontalCenter(), p ? g.top() : g.bottom()), e, 0.5) : new primitives.common.Point(d.x, p ? g.top() : g.bottom());
            ...
            t = new primitives.common.Rect(g.horizontalCenter() + (p != n ? q : -(q + s.width)), g.verticalCenter() - s.height / 2, s.width, s.height)
        }
        ...
        t = new primitives.common.Rect(l.x + (n ? q / 2 : -q /
            2 - s.width), l.y - s.height / 2, s.width, s.height)
    } else {
    ...
    if (0 < f.length) {
        ...
        this.hasLabel && (this.transform.transformRect(t.x, t.y, t.width, t.height, !0, this, function(a, b, c, d) {
...
primitives.common.Connector.prototype._getArrow = function(a, b, c, d, e) {
...
primitives.common.Connector.prototype._quadraticBezierPoint = function(a, b, c, d) {
    return new primitives.common.Point((1 - d) * (1 - d) * a.x + 2 * (1 - d) * d * b.x + d * d * c.x, (1 - d) * (1 - d) * a.y + 2 * (1 - d) * d * b.y + d * d * c.y)
};
primitives.common.Connector.prototype._betweenPoint = function(a, b) {
    return new primitives.common.Point((a.x + b.x) / 2, (a.y + b.y) / 2)
};
primitives.common.Connector.prototype._offsetPoint = function(a, b, c) {
    var d = null,
        d = a.distanceTo(b);
...
primitives.common.Shape.prototype._getLabelPosition = function(a, b, c, d, e, g, f, h) {
    var j = null;
    switch (h) {
        case 1:
        ...
        case 12:
            ...
            break;
        case 4:
            j = new primitives.common.Rect(a + c - e, b + d +
                f, e, g);
            break;
        case 6:
...
primitives.common.DotSegment = function(a, b, c) {
    this.segmentType = 4;
    this.x = a;
    this.y = b;
    this.radius = c
...
primitives.common.Graphics.prototype.polyline = function(a, b) {
    ...
    for (e = 0; e < a.length; e += 1) switch (g = a[e], g.segmentType) {
        ...
        case 0:
            ...
            break;
        case 4:
            this.dot(g.x, g.y, g.radius, b)
    }
};
primitives.common.Graphics.prototype.dot = function(a, b, c, d) {
    var e = this.m_activePlaceholder,
        g = this.m_cache.get(e.name, e.activeLayer.name, "dot"),
        a = {
            position: "absolute",
            width: 2 * c,
            top: b - c + 0.5,
    ...
    null === g ? (g = jQuery("<div></div>"), primitives.common.css(g,
...
primitives.common.CanvasGraphics.prototype.polyline = function(a, b) {
    ...
    if (c.hasGraphics) {
        ...
        for (e = 0; e < a.length; e += 1) switch (d = a[e], d.segmentType) {
            ...
            case 4:
                c.moveTo(Math.round(d.x) + 0.5, Math.round(d.y) + 0.5);
                c.arc(Math.round(d.x) + 0.5, Math.round(d.y) + 0.5, Math.round(d.radius), 0, 2 * Math.PI, !1);
                break;
            case 2:
...
primitives.common.SvgGraphics.prototype.polyline = function(a, b) {
    ...
    for (g = 0; g < a.length; g += 1) switch (f = a[g], f.segmentType) {
        ...
        case 2:
            ...
            break;
        case 4:
            e += "M" + (Math.round(f.x - f.radius) + 0.5) + " " + (Math.round(f.y) + 0.5);
            e += "A" + f.radius + " " + f.radius + " 0 1 0 " + (Math.round(f.x + f.radius) + 0.5) + " " + (Math.round(f.y) + 0.5);
            e += "A" + f.radius + " " + f.radius + " 0 1 0 " + (Math.round(f.x - f.radius) + 0.5) + " " + (Math.round(f.y) + 0.5);
            break;
        case 3:
...
primitives.common.VmlGraphics.prototype.polyline = function(a, b) {
    ...
    for (e = 0; e < a.length; e += 1) switch (f = a[e], f.segmentType) {
        ...
        case 0:
            ...
            break;
        case 4:
            h = Math.round(f.x - f.radius);
            j = Math.round(f.y - f.radius);
            i = Math.round(f.x + f.radius);
            f = Math.round(f.y + f.radius);
            h > i && (k = h, h = i, i = k);
            j > f && (k = j, j = f, f = k);
            h = 10 * h + 5;
            j = 10 * j + 5;
    ...
    null === d ? (d = jQuery(g.create(this.ie8mode)),
        c.activeLayer.canvas.append(d), this.m_cache.put(c.name, c.activeLayer.name, e, d)) : g.update(d[0], this.ie8mode)
};
...
primitives.orgdiagram.BaseController.prototype._drawHighlight = function() {
    ...
    null !== this._highlightTreeItem && (this.graphics.activate("placeholder", 3), a = this._highlightTreeItem.actualPosition, b = new primitives.common.Rect(0, 0, this._highlightTreeItem.actualSize.width, this._highlightTreeItem.actualSize.height), c = this._highlightTreeItem.template.highlightPadding, b.offset(c.left, c.top, c.right, c.bottom), d = new primitives.common.RenderEventArgs, d.context = this._highlightTreeItem.itemConfig, d.isCursor =
        this._highlightTreeItem.isCursor, d.isSelected = this._highlightTreeItem.isSelected, d.templateName = this._highlightTreeItem.template.name, this.transform.transformRect(a.x, a.y, a.width, a.height, !0, this, function(a, c, f, h) {
            this.graphics.template(a, c, f, h, b.x, b.y, b.width, b.height, this._highlightTreeItem.template.highlightTemplate, this._highlightTreeItem.template.highlightTemplateHashCode, this._highlightTreeItem.template.highlightTemplateRenderName, d, {
        ...
        function(g, i, j, p) {
            switch (a.actualVisibility) {
                case 1:
                    ...
                    break;
                case 2:
                    e = b.itemTitleColor, null == e && (e = "#000080"), f.hasOwnProperty(e) || (f[e] = []), h = f[e], h.push(new primitives.common.DotSegment(g + j / 2, i + p / 2, j / 2)), k = this._createLabel(g, i, j, p, a), null != k && c.labels.push(k)
            }
        }));
    ...
    for (c = this.options.annotations.length; b < c; b += 1) switch (k = this.options.annotations[b], k.annotationType) {
        case 0:
            if (null != k.fromItem && null != k.toItem && (e = this._treeItemsByUserId[k.fromItem], g = this._treeItemsByUserId[k.toItem], null != e && null != g)) {
                ...
                j = "connectorShapeType offset lineWidth color lineType labelSize zOrderType".split(" ");
                a = 0;
                for (d = j.length; a < d; a += 1) i = j[a], f[i] = k[i] || h[i];
...
primitives.orgdiagram.BaseController.prototype._redrawConnectors = function() {
    var a = this.graphics.activate("placeholder", 2),
        b = this._visualRootItem,
        c, d, e;
    if (this._treeItems.hasOwnProperty(b)) {
        b = this._treeItems[b];
        c = this._treeLevels[b.level];
        d = new primitives.orgdiagram.Buffer(this.options);
        this._redrawConnector(a.hasGraphics, d, b, c);
        b = d.getPolylines();
        d = 0;
        for (e = b.length; d < e; d += 1) c = b[d], 0 < c.segments.length && (a = {
            borderColor: c.lineColor,
            lineWidth: c.lineWidth,
            lineType: c.lineType
        }, this.graphics.polyline(c.segments,
            a))
    }
};
primitives.orgdiagram.BaseController.prototype._redrawConnector = function(a, b, c, d) {
    ...
    1 >= c.partnerConnectorOffset && 0 == c.childrenConnectorOffset ? b.selectPalette(0) : 1 < c.partnerConnectorOffset ? b.selectPalette(c.partnerConnectorOffset -
        1) : b.selectPalette(d.partnerConnectorOffset + d.childrenConnectorOffset - c.childrenConnectorOffset);
    d = c.parentsConnectionsCount + (c.connectorPlacement & 1 ? 1 : 0);
    1 < d && this.transform.transformPoints(c.actualPosition.horizontalCenter(), c.actualPosition.top(), c.actualPosition.horizontalCenter() + this.options.lineItemsInterval * (d - 1), c.actualPosition.top(), !0, this, function(a, c, d, e) {
    ...
    if (0 < c.visualChildren.length ||
        0 < c.extraChildren.length) e = 4 === c.actualVisibility && c.id === this._visualRootItem, k = c.actualPosition.horizontalCenter();
    if (1 < c.partners.length || 0 < c.extraPartners.length) {
        ...
        d = c.extraPartners;
        for (j = 0; j < d.length; j += 1) f = this._treeItems[d[j]],
            p = new primitives.orgdiagram.ConnectorPoint(f.actualPosition.horizontalCenter(), f.actualPosition.bottom()), p.isSquared = !0, p.highlightPath = f.partnerHighlightPath, p.connectorStyleType = f.partnerHighlightPath ? 2 : 0, g.push(p);
    ...
    if (0 < c.visualChildren.length || 0 < c.extraChildren.length) {
        ...
        for (j = 0; j < d.length; j += 1)
            ...
            else if (f.connectorPlacement & 2) h = this._treeItems[h.treeItems[f.levelPosition + 1]], this.transform.transformPoints(f.actualPosition.right(),
            f.actualPosition.verticalCenter(), h.actualPosition.x, f.actualPosition.verticalCenter(), !0, this,
            function(a, b, c, d) {
                r.push(new primitives.common.MoveSegment(a, b));
                r.push(new primitives.common.LineSegment(c, d))
            });
        ...
        if (0 < d.length) {
            for (j = 0; j < d.length; j += 1) {
                ...
                p = f.parentsConnectionsIndex * this.options.lineItemsInterval;
                f.parentsConnectionsIndex += 1;
                p = new primitives.orgdiagram.ConnectorPoint(f.actualPosition.horizontalCenter() + p, f.actualPosition.top());
                p.isSquared = h;
        ...
        e || this.transform.transformPoints(k,
            l, k, m, !0, this,
            function(a, d, e, f) {
                r = b.getPolyline(n).segments;
                this.showElbowDots && 1 < c.partners.length && r.push(new primitives.common.DotSegment(a, d, 1));
                r.push(new primitives.common.MoveSegment(a, d));
                r.push(new primitives.common.LineSegment(e, f));
                this.showElbowDots && 1 < g.length && r.push(new primitives.common.DotSegment(e, f, 1))
            });
        d = c.visualChildren;
        for (j = 0; j < d.length; j += 1) f = this._treeItems[d[j]], h = this._treeLevels[f.level], this._redrawConnector(a, b, f, h)
    }
};
primitives.orgdiagram.BaseController.prototype._drawTopConnectors = function(a, b, c, d, e) {
    ...
    if (e) {
        ...
        for (i = g; i <= f; i += 1) j = d[i], this.transform.transformPoints(j.x, c, j.x, j.y, !0, this, function(b, c, d, e) {
            ...
            this.showElbowDots && 0 < f - g && m.push(new primitives.common.DotSegment(b, c, 1));
    ...
    for (b = 0; b < f; b += 1) switch (h = d[b], i = a.getPolyline(h.connectorStyleType).segments, k = Math.max(k, h.connectorStyleType), this.transform.transformPoint(g, c, !0, this, function(a, b) {
        ...
        case 2:
            h = new primitives.common.Rect(j, h), e ? g > h.x ? this.transform.transform3Points(h.right(), h.verticalCenter(), h.x, h.verticalCenter(), h.x, h.bottom(), !0, this, function(a, b, c, d, e, f) {
                ...
                i.push(new primitives.common.CubicArcSegment(a, b, c, d, e, f))
            }) : g > h.x ? this.transform.transformPoints(h.x, h.y, h.x, h.bottom(),
                !0, this,
                function(a, b, c, d) {
...
primitives.orgdiagram.BaseController.prototype._setOffset = function(a) {
    ...
    a.rightPadding = Math.max(c, a.parentsConnectionsCount * this._itemsInterval[3]);
    ...
    if (0 < a.visualChildren.length) {
        b = 0;
        for (d = a.visualChildren.length; b <
            d; b += 1) this._setOffset(this._treeItems[a.visualChildren[b]]);
        ...
        if (0 < c) this._offsetItemChildren(a, c);
            ...
            for (b = h.visualChildren.length - 1; 0 <= b; b -= 1)
                ...
                if (null !== f) {
                    ...
                    b = 1;
                    for (d = g.length; b < d; b += 1) a = g[b -
                        1], h = g[b], 2 == a.gravity || 1 == h.gravity ? f[f.length - 1].push(h) : f.push([h])
...
primitives.orgdiagram.BaseController.prototype._recalcLevelsDepth = function() {
    ...
    for (b = this._treeLevels.length; a < b; a += 1) {
        ...
        for (d = e.length; c < d; c += 1) f = this._treeItems[e[c]], h.depth = Math.max(h.depth, f.actualSize.height),
            h.actualVisibility = Math.min(h.actualVisibility, f.actualVisibility), (0 < f.partners.length || 0 < f.extraPartners.length) && i.push(new primitives.orgdiagram.TreeItemsGroup(f)), 0 < f.extraChildren.length && k.push(new primitives.orgdiagram.TreeItemsGroup(f)), f.connectorPlacement & 1 && (f.parentsConnectionsIndex = 1);
        if (0 < i.length) {
            c = 0;
            for (d = i.length; c < d; c += 1) {
                ...
                e = 0;
                for (g = m.length; e < g; e += 1) j = this._treeItems[m[e]], j = j.offset + j.actualSize.width / 2, l.startIndex =
                    null != l.startIndex ? Math.min(l.startIndex, j) : j, l.endIndex = null != l.endIndex ? Math.max(l.endIndex, j) : j
            }
        ...
        if (0 < k.length) {
            ...
            for (d = k.length; c < d; c += 1) {
                ...
                i.push(f.id);
                e = 0;
                for (g = i.length; e < g; e += 1) j = this._treeItems[i[e]], j = j.offset + j.actualSize.width / 2, l.startIndex = null != l.startIndex ? Math.min(l.startIndex, j) : j, l.endIndex = null != l.endIndex ? Math.max(l.endIndex,
                    j) : j
            }
...
primitives.orgdiagram.BaseController.prototype._createVisualTree = function() {
    ...
    if (0 < this._orgItemRoots.length) {
        ...
        for (e in this._orgPartners)
            if (this._orgPartners.hasOwnProperty(e) && null != this._orgPartners[e]) {
                g = this._orgPartners[e];
                b = 0;
                for (c = g.length; b < c; b += 1) {
                    d = g[b];
                    a = this._treeItemsByUserId[e];
                    0 == a.partners.length && a.partners.push(a.id);
                    a.extraPartners.push(this._treeItemsByUserId[d].id);
                    f = this._treeItemsByUserId[d];
                    h = 0;
                    for (j = a.logicalChildren.length; h < j; h += 1) d = this._treeItems[a.logicalChildren[h]],
                        this._defineLogicalParent(f, d)
                }
            } for (e in this._orgChildren)
            if (this._orgChildren.hasOwnProperty(e) && null != this._orgChildren[e]) {
                a = this._treeItemsByUserId[e];
                null != a.relocatedTo && (a = this._treeItems[a.relocatedTo]);
                g = this._orgChildren[e];
                b = 0;
                for (c = g.length; b < c; b += 1) {
                    d = g[b];
                    d = this._treeItemsByUserId[d];
                    a.extraChildren.push(d.id);
                    h = 0;
                    for (j = a.partners.length; h < j; h += 1) f = this._treeItems[a.partners[h]], this._defineLogicalParent(f, d);
                    this._defineLogicalParent(a, d);
                    d.parentsConnectionsCount += 1
                }
            } this._treeItemsByUserId.hasOwnProperty(this.options.cursorItem) &&
            (this._cursorTreeItem = this._treeItemsByUserId[this.options.cursorItem], this._cursorTreeItem.isCursor = !0);
...
primitives.connector.Controller.prototype._redraw = function() {
    ...
    this.m_shape.panelSize = new primitives.common.Size(this.m_panelSize.width,
        this.m_panelSize.height);
...
primitives.famdiagram.Controller.prototype._getEventArgs = function(a, b, c) {
    ...
    if (null != b && null != b.itemConfig.id) {
        ...
        d.position = (new primitives.common.Rect(b.actualPosition)).translate(placeholderOffset.left, placeholderOffset.top).translate(-a.left, -a.top)
    }
    null != c && (d.name = c);
    return d
};
primitives.famdiagram.Controller.prototype._createOrgTree = function() {
    ...
    if (0 < this.options.items.length) {
        ...
        i = [];
        a = c = h = 0;
        for (b = this.options.items.length; a < b; a += 1) d = this.options.items[a], f = this._famItems[d.id], h = Math.min(h, f.level), c = Math.max(c, f.level), null == i[f.level] ? i[f.level] = [d.id] : i[f.level].push(d.id);
        b = {};
        for (a = c; a >= h; a -= 1) {
            l = i[a];
            c = 0;
            for (d = l.length; c < d; c += 1) {
                ...
                e = 0;
                for (g = f.logicalParents.length; e < g; e += 1) k = f.logicalParents[e], b[k] = b.hasOwnProperty(k) ? Math.min(b[k], f.level) : f.level
            }
        }
        a = 0;
        for (b = this.options.items.length; a < b; a += 1) {
            ...
            i = f.logicalChildren.slice(0);
            c = 0;
            for (d = i.length; c < d; c += 1)
                if (h = this._famItems[i[c]], f.level + 1 < h.level) {
                    m = h.logicalParents;
                    e = 0;
                    for (g = h.logicalParents.length; e <
                        g; e += 1) k = this._famItems[h.logicalParents[e]], l = primitives.common.indexOf(k.logicalChildren, h.id), k.logicalChildren.splice(l, 1);
                    h.logicalParents = [];
                    l = [];
                    ...
                    l[h.level] = h;
                    e = 0;
                    for (g = m.length; e < g; e += 1) k = this._famItems[m[e]], k.level <= f.level ? (l[f.level + 1].logicalParents.push(k.id), k.logicalChildren.push(l[f.level +
                        1].id)) : (l[k.level + 1].logicalParents.push(k.id), k.logicalChildren.push(l[k.level + 1].id))
                } for (i = f.logicalChildren.slice(0); 0 < i.length;) {
                m = {};
                f = [];
                c = 0;
                for (d = i.length; c < d; c += 1)
                    if (h = this._famItems[i[c]], !1 == h.isVisible && (e = h.logicalParents.sort().toString(), !primitives.common.isNullOrEmpty(e)))
                        if (m.hasOwnProperty(e)) {
                            p = m[e];
                            e = 0;
                            for (g = h.logicalParents.length; e < g; e += 1) k = this._famItems[h.logicalParents[e]], l = primitives.common.indexOf(k.logicalChildren, h.id), k.logicalChildren.splice(l, 1);
                            h.logicalParents = [];
                            e = 0;
                            for (g = h.logicalChildren.length; e < g; e += 1) k = this._famItems[h.logicalChildren[e]], l = primitives.common.indexOf(k.logicalParents, h.id), k.logicalParents.splice(l, 1), k.logicalParents.push(p.id), p.logicalChildren.push(k.id);
                            delete this._famItems[h.id];
                            delete this._famItemsNonExtracted[h.id];
                            f = f.concat(p.logicalChildren.slice(0))
                        } else m[e] = h;
                i = [];
                c = {};
                e = 0;
                for (g = f.length; e < g; e += 1) l = f[e], c.hasOwnProperty(l) || (i.push(l), c[l] = !0)
            }
        }
        ...
        if (0 < this._families.length) {
            ...
            for (b = this._families.length; a < b; a += 1) {
                e = this._families[a];
                c = 0;
                for (d = e.links.length; c < d; c += 1) g = e.links[c], i = this._famItems[g.fromItem].familyId, k = this._famItems[g.toItem].familyId, i != k && (j.hasOwnProperty(i) || (j[i] = {}), j[i].hasOwnProperty(k) || (j[i][k] =
                    0), j[i][k] += 1, j.hasOwnProperty(k) || (j[k] = {}), j[k].hasOwnProperty(i) || (j[k][i] = 0), j[k][i] += 1), this._families[k].backLinks.push(new primitives.famdiagram.FamLink(g.toItem, g.fromItem))
            }
            for (; f.length < this._families.length;) {
                a = 0;
                for (b = this._families.length; a < b; a += 1)
                    if (e = this._families[a], !h.hasOwnProperty(e.id))
                        if (k = this._findMaximumSpanningTree(j, e.id), k.hasOwnProperty(e.id)) {
                            this._countNumberOfSubFamilies(e.id, k);
                            f.push(e.id);
                            h[e.id] = !0;
                            i = k[e.id];
                            c = 0;
                            for (d = i.length; c < d; c += 1) {
                                l = this._getFamilyAndItsSubFamilies(i[c],
                                    k);
                                e = 0;
                                for (g = l.length; e < g; e += 1) m = l[e], f.push(m), h[m] = !0
                            }
                        } else f.push(e.id), h[e.id] = !0
            }
        }
        this.maximumFamItemId += 1;
        d = this._createOrgItem(this.maximumFamItemId, null, null, this.minimumLevel - 1, null);
        d.hideParentConnection = !0;
        d.hideChildrenConnection = !0;
        d.title = "root";
        d.isVisible = !1;
        this._orgItemRoots.push(d);
        j = {};
        a = 0;
        for (b = f.length; a < b; a += 1) {
            ...
            h = d;
            k = !0;
            i = e.links.concat(e.backLinks);
            for (c = 0; c < i.length; c += 1)
                if (g = i[c], g = this._orgItems[g.toItem], !0 == j[g.familyId]) {
                    c = e.items[0];
                    h = g;
                    for (g = []; h.level >= c.level;) n = h, h = this._orgItems[h.parent], i = this._orgItemChildren[h.id], g.push(primitives.common.indexOf(i, n) > i.length / 2);
                    k = g[Math.max(0, g.length - 2)];
                    break
                } this._attachFamilyToOrgChart(h, n, e, k);
            j[e.id] = !0
        }
    }
};
...
primitives.famdiagram.Controller.prototype._attachFamilyToOrgChart = function(a, b, c, d) {
    for (var e = c.items[0], g = null, g = a, a = a.level + 1; a < e.level; a += 1) this.maximumFamItemId += 1, g = this._createOrgItem(this.maximumFamItemId, g.id, null, a, null), g.title = "shift", g.isVisible = !1, g.hideParentConnection = !0, g.hideChildrenConnection = !0, c.items.push(g);
    e.parent = g.id;
    e.hideParentConnection = !0;
    this._adoptOrgItem(e, b, d)
};
...
primitives.famdiagram.Controller.prototype._createOrgItem = function(a, b, c, d, e) {
    ...
    this._adoptOrgItem(g, null, !0);
    return g
};
primitives.famdiagram.Controller.prototype._adoptOrgItem = function(a, b, c) {
    var d;
    this._orgItems[a.id] = a;
    null != a.parent && (this._orgItemChildren.hasOwnProperty(a.parent) ? (d = this._orgItemChildren[a.parent], null != b ? (b = primitives.common.indexOf(d, b), c ? d.splice(b + 1, 0, a) : d.splice(b, 0, a)) : d.push(a)) : this._orgItemChildren[a.parent] = [a])
};
...
primitives.orgdiagram.Config = function(a) {
    ...
    this.calloutLineWidth = 1;
    this.calloutOpacity = 0.2;
    this.leavesPlacementType = this.childrenPlacementType =
        2;
...
primitives.orgdiagram.Controller.prototype._getEventArgs = function(a, b, c) {
    ...
    null != a && null != a.itemConfig.id && (d.oldContext = this._treeItemConfigs[a.itemConfig.id]);
    null != b && null != b.itemConfig.id && (d.context = this._treeItemConfigs[b.itemConfig.id], null !== b.itemConfig.parent && (d.parentItem = this._treeItemConfigs[b.itemConfig.parent]), placeholderOffset = this.m_placeholder.offset(), a = this.element.offset(), d.position = (new primitives.common.Rect(b.actualPosition)).translate(placeholderOffset.left,
        placeholderOffset.top).translate(-a.left, -a.top));
    null != c && (d.name = c);
    return d
};
...
primitives.orgdiagram.TreeItem = function(a) {
    ...
    this.extraPartners = [];
    this.extraChildren = [];
    this.parentsConnectionsIndex = this.parentsConnectionsCount = this.childrenConnectorOffset = this.partnerConnectorOffset = 0;
    this.visibility = 1;
